...
export default function Toast({ message, type, onClose, duration = 6000 }: ToastProps) {
    ...
    return (
        <div className={`fixed top-4 right-4 z-50 flex items-center w-full max-w-sm p-4 text-white rounded-lg shadow-lg ${bgColors[type]} transition-all duration-300 transform translate-y-0 opacity-100`}>
